    ...
    if chat_id in message_ids:
        for msg_id in message_ids[chat_id]:
            try:
                ...
                @bot.message_handler(
                    func=lambda message: message.text.lower() == 'локации' or message.text.lower() == '/location')
                def info(message):
                ...
                def show_address_details(call):
                    try:
                        ...
                        if category_id in addresses and place_id in addresses[category_id]:
                            ...
                            if coordinates and len(coordinates) == 2 and coordinates[0] is not None and coordinates[
                                1] is not None:
